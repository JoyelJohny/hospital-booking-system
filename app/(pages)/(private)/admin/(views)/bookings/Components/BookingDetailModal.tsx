...
export default function BookingDetailModal({ closeModal }: props) {
    return (
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 justify-center border border-slate-800 bg-white w-11/12 min-h-[450px]  p-3 rounded-xl space-y-4 overflow-y-hidden">
            ...
            <div className="flex">
                <button className="rounded-md w-full px-4 py-2 text-sm font-semibold bg-slate-800 text-white">Cancel Appointment</button>
            </div>
        </div>
    )
}