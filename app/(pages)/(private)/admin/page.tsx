...
export default function Login() {
    ...
    return (<>
        <div className="px-24">
            {/* <Form action={log} className="flex flex-col bg-[#086788] p-6 w-fit h-96 shadow-2xl rounded-lg justify-self-center mt-20 justify-between">
                <h1 className=" text-4xl font-semibold my-6">Administrator Login</h1>
                <div className="flex justify-between gap-4">
                    <label className="font-semibold py-2 ">Username</label>
                    <input type="email" required className="rounded-md text-black p-1 focus:outline-slate-600 w-full" />
                </div>
                <div className=" flex justify-between gap-4">
                    <label className="font-semibold py-2">Password</label>
                    <input type="password" required className="rounded-md text-black p-1 focus:outline-slate-600 w-full " />
