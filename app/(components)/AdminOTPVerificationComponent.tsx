...
export default function AdminSignUpComponent() {
    return (
        <Form action={(e) => (console.log(e))} className="flex flex-col bg-white p-5 rounded-md h-2/3 justify-around my-auto drop-shadow-xl text-sm md:w-2/4 md:mx-auto lg:w-1/3 xl:w-1/4">
            ...
            <span className="text-gray-600 lg:hover:text-blue-600 lg:hover:underline">Already Have an Account ? <span className="text-blue-700 cursor-pointer">Login</span></span>
        </Form>)
}